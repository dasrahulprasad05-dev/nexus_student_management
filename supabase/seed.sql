...
-- ==========================================================
-- Run migration.sql first, then paste this entire file into
...
-- ==========================================================
-- STEP 0: CLEAN SLATE — Remove any previously seeded data
-- ==========================================================
...
--   Students → student123
--   Parent   → parent123
-- FIX: instance_id is required for Supabase GoTrue authentication
-- ==========================================================
...
-- ==========================================================
-- STEP 3: UPDATE TEACHER DETAILS
-- (Trigger already created the profile + teacher rows on auth insert)
-- ==========================================================
...
-- (Trigger already created the profile + student rows on auth insert)
-- ==========================================================
...
VALUES
  (
    ...
    'c0000000-0000-0000-0000-00000000010a',
    'Physics Unit Test 1',
    'unit', 50, 'Physics',
    CURRENT_DATE - 15
  ),
  (
    ...
    'midterm', 100, 'Mathematics',
    CURRENT_DATE - 5
  )
ON CONFLICT (id) DO NOTHING;

-- ==========================================================
-- STEP 7: INSERT EXAM MARKS
-- ==========================================================
...
VALUES
  (
    uuid_generate_v4(),
    'Midterm Results Declared',
    'The results for Mathematics Midterm 2026 have been published. Check your marksheet on your dashboard.',
    'announcement',
    'a0000000-0000-0000-0000-000000000001',
    now()
  ),
  (
    ...
    'Join us for the inter-school robotics battle next Friday. Win cash prizes and merit badges!',
    'event',
    'b0000000-0000-0000-0000-000000000002',
    now() - interval '2 days'
  )
...
VALUES
  (
    ...
    'consistent_learner',
    'Consistent Learner',
    'Logged in and checked notifications every day for 2 weeks.',
    now() - interval '4 days'
  ),
  (
    uuid_generate_v4(),
    ...
    'top_performer',
    'Top Performer',
    'Scored a perfect score in Mathematics Midterm.',
    now() - interval '1 day'
  )
ON CONFLICT (id) DO NOTHING;

-- ==========================================================
-- STEP 11: INSERT ATTENDANCE RECORDS (Last 3 days)
-- ==========================================================
...
--   teacher.sarah@nexus.edu / teacher123
--   teacher.alan@nexus.edu  / teacher123
--   student.john@nexus.edu  / student123
--   student.jane@nexus.edu  / student123
--   parent@nexus.edu        / parent123
-- ==========================================================
